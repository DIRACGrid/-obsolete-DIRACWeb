...
${ h.javascript_include_tag( "/ext-2.0.2/adapter/ext/ext-base.js" ) }
${ h.javascript_include_tag( "/ext-2.0.2/ext-all-debug.js" ) }
${ h.javascript_include_tag( "/javascripts/Lib.js" ) }
${ h.javascript_include_tag( "/javascripts/jobs/JobMonitor.js" ) }
${ h.stylesheet_link_tag( "/ext-2.0.2/resources/css/ext-all.css" ) }
</head>
