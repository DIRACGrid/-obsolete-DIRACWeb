...
function showPage(totaljobs){
  ...
  if(pages > 10){
    if(page > 10){
      pages_content = pages_content + "<a href=\"javascript:ftssubmit(" + (page - 10) + ");\">&lt;&lt;</a>&nbsp;&nbsp;";
    }
    if(page > 3){
...
function fuckinMenu(id,x,y){
  ...
  job_menu.addItems([
    {text:"Show Info",url:"javascript:showInfo(" + id + ")"}
/*
...
*/
  ...
  job_menu.setItemGroupTitle("FTS Request ID: " + id, 0); 
